...
test_that("Other functions don't run without data being loaded", {
  ...
  expect_error(cross.combinations("imaginary"),"Please load.data first")
  expect_error(cross.dc.combinations("imaginary"),"Please load.data first")
  ...
  expect_error(save.local.GEBVs("imaginary", "imaginary2"),"Please load.data first")
