...
#' Add or replace the centring values of a set of marker effects
#' 
...
#' with it after this function call. 
#' 
#' @param allele Character symbol of the allele whose effects across these markers
#' should be centred by these values.
#' @param reset.centres If true, the centring values of the marker effect set after 
...
#' the next alleles.
#' @inheritParams change.eff.set.centres
#' 
#' @family loader functions
#' @export
