---
title: "genomicSimulation (v0.2.6.development) Vignette"
...
output:
  rmarkdown::html_vignette:
      ...
      #theme: simplex
vignette: >
  %\VignetteIndexEntry{genomicSimulation (v0.2.6.development) Vignette}
...
An example of using custom labels to track sex can be found in the example script [Tracking sex of genotypes](#tracking-sex-of-genotypes) in this document. Other examples of using custom labels exist in the [Features and Template Guide](https://vllrs.github.io/genomicSimulationCdocs/v0.2.6/templates.html) (online link).
...
The [Features and Template Guide](https://vllrs.github.io/genomicSimulationCdocs/v0.2.6/templates.html) (online link) provides template implementations of various breeding program features, such as selecting using an index, or tracking genotype age.
